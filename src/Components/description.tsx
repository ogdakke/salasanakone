                ...
                <details className="details">
                    ...
                    <div className="summaryDetails">
                        <p>
                            ...
                            <br />
                            Hyvä salasana on riittävän pitkä (yli 14 kirjainta)
                            ja sisältää numeroita, erikoismerkkejä sekä isoja ja
                            pieniä kirjaimia.
                        </p>
                        <ul>
                            <li>
                                Tällä salasanakoneella voit luoda
                                automaattisesti vahvan ja muistettavissa olevan
                                salasanan, joka on lisäksi vielä helppo
                                kirjoittaa.
                            </li>
                            <li>
                                Tämä salasanageneraattori on vahva tapa luoda
                                salasanoja, sillä itse keksimät salasanat ovat
                                monesti liian heikkoja ja arvattavia.
                            </li>
                        </ul>
                    </div>
                </details>
                ...
                <details className="details">
                    ...
                    <div className="summaryDetails">
                        <p>
                            ...
                            lisää haluamasi välimerkit ja numerot sanojen
                            väliin.
                        </p>
                    </div>
                </details>
                ...
                <details className="details">
                    ...
                    <div className="summaryDetails">
                        <p id="miten-vahvuus-arvioidaan">
                            Vahvuuden arviointi tapahtuu samalla, Dropboxin
                            avoimen lähdekoodin ohjelmalla, kuin{" "}
                            <ExternalLink
                            ...
                            <strong>
                                Tosin, tämä kone ottaa huomioon suomalaiset
                                sanat
                            </strong>
                            , jotta arviointi on mahdollisimman tarkka.
                        </p>
                        <p>
                            Kone arvioi salasanan vahvuuden mm. pituuden,
                            satunnaisuuden, ja yleisyyden perusteella. Lisäksi
                            kone vertaa salasanaa suomen kielen sanakirjaan, ja
                            sitä kautta laskee realistisemman vahvuuden, mikäli
                            sanat ilmenevät muuttamattomina sanakirjassa.
                        </p>
                    </div>
                </details>
                <Divider margin={"0.5rem 0"} />
