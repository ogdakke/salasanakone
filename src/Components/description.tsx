      ...
      <article aria-label="description" className="description">
        ...
        <section>
          ...
          <p>
            ...
            muistettava salasana.
            <br />
            Hyvä salasana on riittävän pitkä (yli 14 kirjainta) ja sisältää numeroita,
            erikoismerkkejä sekä isoja ja pieniä kirjaimia.
          </p>
          <ul>
            <li>
              Tällä salasanakoneella voit luoda automaattisesti vahvan ja muistettavissa olevan
              salasanan, joka on lisäksi vielä helppo kirjoittaa.
            </li>
            <li>
              Tämä salasanageneraattori on vahva tapa luoda salasanoja, sillä itse keksimät
              salasanat ovat monesti liian heikkoja ja arvattavia.
            </li>
          </ul>
        </section>
        ...
        <details className="details">
          ...
          <div className="summaryDetails">
            ...
            <p>
              Kone arvioi salasanan vahvuuden mm. pituuden, satunnaisuuden, ja yleisyyden
              perusteella. Lisäksi kone vertaa salasanaa suomen kielen sanakirjaan, ja sitä kautta
              laskee realistisemman vahvuuden, mikäli sanat ilmenevät muuttamattomina sanakirjassa.
            </p>
          </div>
        </details>
        <Divider margin={"0.5rem 0"} />
